...
public class JavaCodelot extends Language{
    ...
    private Building makeBuilding1(String bname){
        ...
        flr2.setTaskDescription("Theres also another type of print: System.out.print(). " +
                ...
                "Type in 'System.out.print();' with your first name, then 'System.out.println();'" +
        ...
        flr3.setTaskDescription("Theres no computation without data types so lets " +
                "explore some of the data types available in Java. Here we learn int. \n"+
                "Type in 'System.out.println();' with 1 in between the two parentheses." +

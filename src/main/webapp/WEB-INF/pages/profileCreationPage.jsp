...
<div class="formWrapper">
    ...
    <div id="createProfile" class="wood-bg">
        ...
        <h2 class="formTitle">Create Profile</h2>
        <form action="/profileCreation2" method="post">
            <table class="form-group createTable">
                ...
                <td>
                    <a class="button w-button" onclick="$('#createUser').click();"><strong>Create</strong></a>
                    <input style="display:none" id="createUser" type="submit" value="Create"/>
                </td>
                </tr>

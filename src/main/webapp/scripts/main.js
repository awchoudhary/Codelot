...
var mainstate = {
    preload:function () {
        ...
        game.load.tilemap("ItsTheMap","../images/testMap.json",null,Phaser.Tilemap.TILED_JSON)
        var img = game.load.image("magecity","../images/magecity.png")
        game.load.spritesheet('dude', '../images/dude.png', 32, 48);
    },

    create:function () {
        map = game.add.tilemap("ItsTheMap",32,32,64,32);
        map.addTilesetImage("magecity","magecity");
